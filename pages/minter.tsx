...
const CreateListing = () => {
  ...
  return (
    <StyledMinter theme_={theme}>
      <Loader visible={loading} />
      <motion.div className="page_header">
        <h2 className="page_title text-gradient">Mint the Yooci Nft</h2>
      </motion.div>
      <motion.div className="page_container">
        ...
        <form onSubmit={submitHandler}>
          <Input
            ...
            label="Name"
            asterik={true}
            placeholder="What do you want to name your Nft"
...
const StyledMinter = styled(motion.div)`
  display: flex;
